...
env_vars <- read_parquet("Data/Encounter Rate/Habitat/eBird_Rock_Kestrel_environmental_variables.parquet")

# zero-filled ebird data combined with environmental data
checklists_env <- read_parquet("Data/Encounter Rate/Checklists/eBird_Rock_Kestrel_zf.parquet") |> 
...
write_csv(ppms, "Results/Habitat Associations/Rock_Kestrel_metrics.csv")
...
write_csv(pred_imp_standard, "Results/Habitat Associations/Rock_Kestrel_predictor_importance.csv")
...
write_csv(pd, "Results/Habitat Associations/Rock_Kestrel_partial_dependence.csv")
...
#        axis.line = element_line(color = "Rock60"),
#        axis.ticks  = element_line(color = "Rock60"))
...
write_csv(df, "Results/Habitat Associations/Rock_Kestrel_Habitat_Associations.csv")
