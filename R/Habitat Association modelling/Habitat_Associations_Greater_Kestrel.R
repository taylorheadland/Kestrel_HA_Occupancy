...
env_vars <- read_parquet("Data/Encounter Rate/Habitat/eBird_Greater_Kestrel_environmental_variables.parquet")

# zero-filled ebird data combined with environmental data
checklists_env <- read_parquet("Data/Encounter Rate/Checklists/eBird_Greater_Kestrel_zf.parquet") |> 
...
write_csv(ppms, "Results/Habitat Associations/Greater_Kestrel_metrics.csv")
...
write_csv(pred_imp_standard, "Results/Habitat Associations/Greater_Kestrel_predictor_importance.csv")
...
write_csv(pd, "Results/Habitat Associations/Greater_Kestrel_partial_dependence.csv")
...
#        axis.line = element_line(color = "Greater60"),
#        axis.ticks  = element_line(color = "Greater60"))
...
write_csv(df, "Results/Habitat Associations/Greater_Kestrel_Habitat_Associations.csv")
