...
species <- "Spotted Kestrel"

# environmental variables: landcover and elevation
env_vars <- read_parquet("Data/Encounter Rate/Habitat/eBird_Spotted_Kestrel_environmental_variables.parquet")

# zero-filled ebird data combined with environmental data
checklists_env <- read_parquet("Data/Encounter Rate/Checklists/eBird_Spotted_Kestrel_zf.parquet") |> 
...
write_csv(ppms, "Results/Habitat Associations/Spotted_Kestrel_metrics.csv")
...
write_csv(pred_imp_standard, "Results/Habitat Associations/Spotted_Kestrel_predictor_importance.csv")
...
write_csv(pd, "Results/Habitat Associations/Spotted_Kestrel_partial_dependence.csv")
...
write_csv(df, "Results/Habitat Associations/Spotted_Kestrel_Habitat_Associations.csv")
=======
library(dplyr)
library(ebirdst)
library(ggplot2)
...
checklists_env <- read_parquet("Data/Encounter Rate/Checklists/eBird_Spotted_Kestrel_zf.parquet") |> 
  inner_join(env_vars, by = "checklist_id") |> 
  select(-pland_LCCS3_c10_dense_forest, -ed_LCCS3_c10_dense_forest)
...
write_csv(df, "Results/Habitat Associations/Spotted_Kestrel_Habitat_Associations.csv")
>>>>>>> c794377de621ac88478caca41b23ef316fa370a6
