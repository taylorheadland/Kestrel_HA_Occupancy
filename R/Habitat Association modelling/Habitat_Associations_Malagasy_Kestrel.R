...
species <- "Malagasy Kestrel"

# environmental variables: landcover and elevation
env_vars <- read_parquet("Data/Encounter Rate/Habitat/eBird_Malagasy_Kestrel_environmental_variables.parquet")

# zero-filled ebird data combined with environmental data
checklists_env <- read_parquet("Data/Encounter Rate/Checklists/eBird_Malagasy_Kestrel_zf.parquet") |> 
...
write_csv(ppms, "Results/Habitat Associations/Malagasy_Kestrel_metrics.csv")
...
write_csv(pred_imp_standard, "Results/Habitat Associations/Malagasy_Kestrel_predictor_importance.csv")
...
write_csv(pd, "Results/Habitat Associations/Malagasy_Kestrel_partial_dependence.csv")
...
write_csv(df, "Results/Habitat Associations/Malagasy_Kestrel_Habitat_Associations.csv")
