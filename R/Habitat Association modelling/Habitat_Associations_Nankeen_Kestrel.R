...
env_vars <- read_parquet("Data/Encounter Rate/Habitat/eBird_Nankeen_Kestrel_environmental_variables.parquet")

# zero-filled ebird data combined with environmental data
checklists_env <- read_parquet("Data/Encounter Rate/Checklists/eBird_Nankeen_Kestrel_zf.parquet") |> 
...
write_csv(ppms, "Results/Habitat Associations/Nankeen_Kestrel_metrics.csv")
...
write_csv(pred_imp_standard, "Results/Habitat Associations/Nankeen_Kestrel_predictor_importance.csv")
...
write_csv(pd, "Results/Habitat Associations/Nankeen_Kestrel_partial_dependence.csv")
...
#        axis.line = element_line(color = "Nankeen60"),
#        axis.ticks  = element_line(color = "Nankeen60"))
...
write_csv(df, "Results/Habitat Associations/Nankeen_Kestrel_Habitat_Associations.csv")
