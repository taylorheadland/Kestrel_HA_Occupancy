...
habitat <- read_parquet("Data/Occupancy/Habitat/eBird_Nankeen_Kestrel_Darwin_environmental_variables.parquet")

# Read in checklist data and join in habitat data
checklists <- read_parquet("Data/Occupancy/Checklists/eBird_Nankeen_Kestrel_Darwin.parquet") %>% 
...
species_name_city <- "Nankeen_Kestrel_Darwin"
...
write_csv(results_df, "Results/Occupancy models/Nankeen_Kestrel_Darwin_Occupancy_model_summary.csv")
...
#Save
write_csv(results_df_st, "Results/Occupancy models/Nankeen_Kestrel_Darwin_Occupancy_st_stats.csv")
...
# Save
write_csv(results_df_GOF, "Results/Occupancy models/Nankeen_Kestrel_Darwin_Occupancy_GOF.csv")