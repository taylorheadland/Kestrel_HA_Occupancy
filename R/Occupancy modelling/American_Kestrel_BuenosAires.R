...
habitat <- read_parquet("Data/Occupancy/Habitat/eBird_American_Kestrel_BuenosAires_environmental_variables.parquet")

# Read in checklist data and join in habitat data
checklists <- read_parquet("Data/Occupancy/Checklists/eBird_American_Kestrel_BuenosAires.parquet") %>% 
...
Kestrel.inits <- list(beta = 0, alpha = 0, z = z.inits, 
                      sigma.sq = 2.1, phi = 0.6, 
                      sigma.sq.t = 0.3, rho = 0, w = rep(0, nrow(Kestrel.data$y)))
...
species_name_city <- "American_Kestrel_BuenosAires"
...
write_csv(results_df, "Results/Occupancy models/American_Kestrel_BuenosAires_Occupancy_model_summary.csv")
...
#Save
write_csv(results_df_st, "Results/Occupancy models/American_Kestrel_BuenosAires_Occupancy_st_stats.csv")
...
# Save
write_csv(results_df_GOF, "Results/Occupancy models/American_Kestrel_BuenosAires_Occupancy_GOF.csv")