...
habitat <- read_parquet("Data/Occupancy/Habitat/eBird_Nankeen_Kestrel_Sydney_environmental_variables.parquet")

# Read in checklist data and join in habitat data
checklists <- read_parquet("Data/Occupancy/Checklists/eBird_Nankeen_Kestrel_Sydney.parquet") %>% 
...
species_name_city <- "Nankeen_Kestrel_Sydney"
...
write_csv(results_df, "Results/Occupancy models/Nankeen_Kestrel_Sydney_Occupancy_model_summary.csv")
...
#Save
write_csv(results_df_st, "Results/Occupancy models/Nankeen_Kestrel_Sydney_Occupancy_st_stats.csv")
...
# Save
write_csv(results_df_GOF, "Results/Occupancy models/Nankeen_Kestrel_Sydney_Occupancy_GOF.csv")