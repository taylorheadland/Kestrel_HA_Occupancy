...
habitat <- read_parquet("Data/Occupancy/Habitat/eBird_Nankeen_Kestrel_Brisbane_environmental_variables.parquet")

# Read in checklist data and join in habitat data
checklists <- read_parquet("Data/Occupancy/Checklists/eBird_Nankeen_Kestrel_Brisbane.parquet") %>% 
...
Kestrel.inits <- list(beta = 0, alpha = 0, z = z.inits, 
                      sigma.sq = 4.8, phi = 0.5, 
                      sigma.sq.t = 0.4, rho = 0, w = rep(0, nrow(Kestrel.data$y)))
...
species_name_city <- "Nankeen_Kestrel_Brisbane"
...
write_csv(results_df, "Results/Occupancy models/Nankeen_Kestrel_Brisbane_Occupancy_model_summary.csv")
...
#Save
write_csv(results_df_st, "Results/Occupancy models/Nankeen_Kestrel_Brisbane_Occupancy_st_stats.csv")
...
# Save
write_csv(results_df_GOF, "Results/Occupancy models/Nankeen_Kestrel_Brisbane_Occupancy_GOF.csv")