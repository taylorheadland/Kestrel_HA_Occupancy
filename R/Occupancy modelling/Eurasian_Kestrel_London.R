...
habitat <- read_parquet("Data/Occupancy/Habitat/eBird_Eurasian_Kestrel_London_environmental_variables.parquet")

# Read in checklist data and join in habitat data
checklists <- read_parquet("Data/Occupancy/Checklists/eBird_Eurasian_Kestrel_London.parquet") %>% 
...
species_name_city <- "Eurasian_Kestrel_London"
...
write_csv(results_df, "Results/Occupancy models/Eurasian_Kestrel_London_Occupancy_model_summary.csv")
...
#Save
write_csv(results_df_st, "Results/Occupancy models/Eurasian_Kestrel_London_Occupancy_st_stats.csv")
...
# Save
write_csv(results_df_GOF, "Results/Occupancy models/Eurasian_Kestrel_London_Occupancy_GOF.csv")