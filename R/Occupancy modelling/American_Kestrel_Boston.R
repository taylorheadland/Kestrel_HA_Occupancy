...
habitat <- read_parquet("Data/Occupancy/Habitat/eBird_American_Kestrel_Boston_environmental_variables.parquet")

# Read in checklist data and join in habitat data
checklists <- read_parquet("Data/Occupancy/Checklists/eBird_American_Kestrel_Boston.parquet") %>% 
...
species_name_city <- "American_Kestrel_Boston"
...
write_csv(results_df, "Results/Occupancy models/American_Kestrel_Boston_Occupancy_model_summary.csv")
...
#Save
write_csv(results_df_st, "Results/Occupancy models/American_Kestrel_Boston_Occupancy_st_stats.csv")
...
# Save
write_csv(results_df_GOF, "Results/Occupancy models/American_Kestrel_Boston_Occupancy_GOF.csv")